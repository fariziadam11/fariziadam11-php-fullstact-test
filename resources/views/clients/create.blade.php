            ...
            <div class="row mb-3">
                <div class="col-md-3">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('client_prefix') is-invalid @enderror" id="client_prefix" name="client_prefix" value="{{ old('client_prefix') }}" maxlength="4" required>
                ...
                <div class="col-md-3">
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('is_project') is-invalid @enderror" id="is_project" name="is_project" required>
                            <option value="0" {{ old('is_project') == '0' ? 'selected' : '' }}>No</option>
                            <option value="1" {{ old('is_project') == '1' ? 'selected' : '' }}>Yes</option>
                        </select>
                        @error('is_project')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                ...
                <div class="col-md-3">
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('self_capture') is-invalid @enderror" id="self_capture" name="self_capture" required>
                            <option value="1" {{ old('self_capture') == '1' ? 'selected' : '' }}>Yes</option>
                            <option value="0" {{ old('self_capture') == '0' ? 'selected' : '' }}>No</option>
                        </select>
                        @error('self_capture')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                ...
                <div class="col-md-3">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('city') is-invalid @enderror" id="city" name="city" value="{{ old('city') }}" maxlength="50">
                        @error('city')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('phone_number') is-invalid @enderror" id="phone_number" name="phone_number" value="{{ old('phone_number') }}" maxlength="50">
                        @error('phone_number')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <small class="text-muted">Max size: 2MB. Recommended dimensions: 200x200px</small>
                        @error('client_logo')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
